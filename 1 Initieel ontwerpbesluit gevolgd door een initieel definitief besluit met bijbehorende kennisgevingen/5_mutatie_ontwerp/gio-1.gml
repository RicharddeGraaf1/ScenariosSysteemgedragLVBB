...
<geo:GeoInformatieObjectVaststelling xmlns:geo="https://standaarden.overheid.nl/stop/imop/geo/"
   ...
   <geo:vastgesteldeVersie>
      <geo:GeoInformatieObjectVersie>
         <geo:FRBRWork>/join/id/regdata/gm0363/2023/IO_2023102616_3855330_5-gio-1</geo:FRBRWork>
         <geo:FRBRExpression>/join/id/regdata/gm0363/2023/IO_2023102616_3855330_5-gio-1/nld@2023-10-26;5</geo:FRBRExpression>
         <geo:locaties>
            <geo:Locatie>
               <geo:geometrie>
                  <basisgeo:Geometrie xmlns:basisgeo="http://www.geostandaarden.nl/basisgeometrie/1.0"
                                      xmlns:gml="http://www.opengis.net/gml/3.2"
                                      gml:id="id-50f0daf8-05db-45f1-9dd9-a5013f2d586b-xx">
                     <basisgeo:id>50f0daf8-05db-45f1-9dd9-a5013f2d586b</basisgeo:id>
                     <basisgeo:geometrie>
                        <gml:MultiSurface gml:id="id-50f0daf8-05db-45f1-9dd9-a5013f2d586b"
                                          srsName="urn:ogc:def:crs:EPSG::28992">
                           <gml:surfaceMember>
                              <gml:Polygon gml:id="id-50f0daf8-05db-45f1-9dd9-a5013f2d586b-1">
                                 <gml:exterior>
                                    <gml:LinearRing>
